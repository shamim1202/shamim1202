![Header](https://github.com/shamim1202/shamim1202/blob/ee46105a3369396e75996bdd476ef35d33752134/github-header-banner.png)


## 👋 Hey there, I’m Mehedi — Developer & Tech Enthusiast

I am a MERN Stack Developer who loves building modern, scalable, and user-centric web applications. I love solving real-world problems with clean code, efficient architecture, and technology. My work revolves around the entire MERN ecosystem -**MongoDB, Express, React, and Node.js** - and I am constantly learning tools that help me improve both frontend and backend development.

#### 🔹 What I Do
- Build responsive and interactive UIs using - ***React***
- Develop secure and scalable REST APIs with - ***Node.js + Express***
- Design and manage databases with - ***MongoDB***
- Work with modern tools like - ***Git,*** ***GitHub,*** ***Postman,***
- Familiar with Modern Library & Others - ***TailwindCSS***, ***Firebase***, ***REST APIs*** 
- Deploy applications to cloud platforms - ***Vercel***, ***Netlify***
...
## 👾  What I am interested to learning 
...
- [zap-shift-client](https://github.com/shamim1202/zap-shift-client): A client-side application for managing shift schedules. ⭐️ 0 Stars | 💾 0 Forks | 🐛 0 Open Issues
- [daily-loop-client](https://github.com/shamim1202/daily-loop-client): A client app that provides daily task management features. ⭐️ 0 Stars | 💾 0 Forks | 🐛 0 Open Issues
- [daily-loop-server](https://github.com/shamim1202/daily-loop-server): The server-side implementation for daily loop application. ⭐️ 0 Stars | 💾 0 Forks | 🐛 0 Open Issues
- [smart-deals-client](https://github.com/shamim1202/smart-deals-client): A client application for a smart deals platform. ⭐️ 0 Stars | 💾 0 Forks | 🐛 0 Open Issues
- [dragon-news](https://github.com/shamim1202/dragon-news): A news aggregation application built with MERN stack. ⭐️ 0 Stars | 💾 0 Forks | 🐛 0 Open Issues
...
- Pushed to [zap-shift-client](https://github.com/shamim1202/zap-shift-client) on 2025-11-17
- Updated [daily-loop-client](https://github.com/shamim1202/daily-loop-client) on 2025-11-13
- Committed changes to [daily-loop-server](https://github.com/shamim1202/daily-loop-server) on 2025-11-13
- Pushed updates to [smart-deals-client](https://github.com/shamim1202/smart-deals-client) on 2025-11-07
